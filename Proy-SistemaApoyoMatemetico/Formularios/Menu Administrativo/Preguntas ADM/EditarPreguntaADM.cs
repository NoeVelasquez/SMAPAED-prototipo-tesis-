...
{
    public partial class EditarPreguntaADM : Form
    {
        ...
        private void EditarPreguntaADM_Load(object sender, EventArgs e)
        {
        ...
        private void Eliminacion(string operacion)
        {
            AccesoDatos.clsaccesodatos servidor = new AccesoDatos.clsaccesodatos();
            servidor.cadenaconexion = ruta;
            if (servidor.abrirconexiontrans() == true)
            {
                servidor.ejecutar("[dbo].[EliminarPregunta]", false, ref rpta, ref mensaje
        ...
        public EditarPreguntaADM(int idbusqueda) : this()
        {
        ...
        {
            if (MessageBox.Show("¿Esta seguro de Eliminar la Pregunta?", "Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
            {
                Eliminacion("N");
                dato = Convert.ToInt32(LblIDDoc.Text);
            }

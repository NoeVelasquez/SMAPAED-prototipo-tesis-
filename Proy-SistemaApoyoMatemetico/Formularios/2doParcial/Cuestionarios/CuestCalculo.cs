...
{
    public partial class CuestCalculo : Form
    {
        int i, puntos = 0;
        string Opcorrecto;
        ...
        public CuestCalculo(int idbusqueda) : this()
        {
        ...
        private void CuestCalculo_Load(object sender, EventArgs e)
        {
            ...
            i = Convert.ToInt32(rc.scalerReturn("select  min (IDPreg) from Preguntas where IDEx_Fk=6"));
            TxtPregunta.Text = rc.scalerReturn("select Titulo  from Preguntas where IDPreg = '" + i + "'and IDEx_Fk=6");
            Rb1.Text = rc.scalerReturn("select opA  from Preguntas where IDPreg = '" + i + "'and IDEx_Fk=6");
            Rb2.Text = rc.scalerReturn("select opB  from Preguntas where IDPreg = '" + i + "'and IDEx_Fk=6");
            Rb3.Text = rc.scalerReturn("select opC  from Preguntas where IDPreg = '" + i + "'and IDEx_Fk=6");
            Rb4.Text = rc.scalerReturn("select opD  from Preguntas where IDPreg = '" + i + "'and IDEx_Fk=6");
            Opcorrecto = rc.scalerReturn("select opCorrecto  from Preguntas where IDPreg = '" + i + "'and IDEx_Fk=6");
        }
        ...
        private void Siguiente_Click(object sender, EventArgs e)
        {
            ...
            s = rc.scalerReturn("select min(IDPreg) from Preguntas where IDPreg > '" + i + "' and IDEx_Fk = 6");
            if (s.Equals(""))
            {
                ...
                MS.LblNotaT7.Text = puntos.ToString();

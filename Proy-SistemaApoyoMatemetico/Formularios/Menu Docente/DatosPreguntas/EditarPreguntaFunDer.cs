...
{
    public partial class EditarPreguntaFunDer : Form
    {
        ...
        public EditarPreguntaFunDer()
        {
            InitializeComponent();
        }
        public EditarPreguntaFunDer(int idbusqueda) : this()
        {
        ...
        private void EditarPreguntaFunDer_Load(object sender, EventArgs e)
        {
            ...
            TablaPreguntasEditar.DataSource = NP.ListarPreguntaFD().Tables["tbl"];
            //bitsFoto =(byte[])
            ...
            TablaPreguntasEditar.Columns["IDU_Fk"].Visible = false;
        ...
        private void Mantenimiento(string operacion)
        {
            ...
            {
                servidor.ejecutar("[dbo].[EditarPreguntaFyD]", false, ref rpta, ref mensaje

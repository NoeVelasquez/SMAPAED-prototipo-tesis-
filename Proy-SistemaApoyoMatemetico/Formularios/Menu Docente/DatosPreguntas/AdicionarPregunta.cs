...
{
    public partial class AdicionarPregunta : Form
    {
        ...
        private void AdicionarPregunta_Load(object sender, EventArgs e)
        {
        ...
        private void BtAgregarPregunta_Click(object sender, EventArgs e)
        {
            ...
            //bool respuesta;
            //NP.Titulo = TxtPregunta.Text;
            //NP.Foto = ConvertirIMA();
            //NP.opA = TxtOpA.Text;
            //NP.opB = TxtOpB.Text;
            //NP.opC = TxtOpC.Text;
            //NP.opD=TxtOpD.Text;
            //NP.opCorrecto = TxtOpCorrecto.Text;
            //NP.FechaActualizacion = System.DateTime.Now.ToShortDateString();
            //NP.IDC_Fk = Convert.ToInt32(LblIDDoc.Text);
            //NP.IDEx_Fk = CBDatoExamen.SelectedValue.ToString();
            //respuesta = pregunta.ValidarPregunta(NP);
            //if (respuesta == false)
            //{
            //    return;
            //}
            //pregunta.CrearPregunta(NP);
            
            //Pre.Foto = ImagenPregunta.ImageLocation;
            /*****IMPORTANTE *****/
            bool respuesta;
        ...
        private void Mantenimiento (string operacion)
        {
            ...
            {
                     servidor.ejecutar("[dbo].[ParaCrePregunta]", false, ref rpta,ref mensaje
                        ,1
                        , TxtPregunta.Text
                        , this.buffer
                        , TxtOpA.Text
        ...
        public AdicionarPregunta(int idbusqueda) : this()
        {
        ...
        private void Limpiar()
        {
            ...
            CBDatoExamen.SelectedValue = 1;
        }

        private void CBDatoExamen_SelectedIndexChanged(object sender, EventArgs e)
        {
